        ...
        <Container>
            <div className="flex border  bg-gradient-to-tr from-purple-300 to-blue-400">
                <div className="hidden lg:block w-full md:w-1/2 xl:w-2/3 ">
                    <img src="https://i.pinimg.com/564x/ec/8c/10/ec8c10315f150bffe0663168ee941c27.jpg" alt="" className="w-full  object-cover" />
                </div>

                <div className=" w-full md:max-w-md lg:max-w-full md:mx-auto  md:w-1/2  px-6 
        flex items-center justify-center">

                    <div className="w-full">
                        <h1 className="text-xl md:text-2xl font-bold leading-tight ">Student Details</h1>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <button type="submit" className="w-full btn mt-4 btn-outline">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
